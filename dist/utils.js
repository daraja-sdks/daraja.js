...
function errorAssert(condition, msg) {
    if (!condition) {
        const tmpl = `
...
class HttpClient {
    constructor(env = "sandbox") {
        this.env = env;
        this.env === "production"
            ? (this.baseUrl = routes_1.routes.production)
...
exports.getProductionCert = getProductionCert;
function getSandboxCert() {
    return `-----BEGIN CERTIFICATE-----
...
exports.getSandboxCert = getSandboxCert;
